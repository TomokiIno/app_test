...
export default function CounterButton() {
  ...
  // イベントの型を明示的に指定
  const colorCordChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  // イベントの型を明示的に指定
  const redColorChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  // イベントの型を明示的に指定
  const greenColorChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const value = parseInt(e.target.value, 10);
  ...
  // イベントの型を明示的に指定
  const blueColorChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const value = parseInt(e.target.value, 10);
